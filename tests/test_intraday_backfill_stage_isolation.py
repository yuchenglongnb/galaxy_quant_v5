...
def test_filter_universe_stage_index_skips_etf_and_stock():
    ...
    filtered = backfill_module._filter_universe(universe, stage="index", max_stocks=0, only_codes=[])
...
def test_filter_universe_stage_stock_applies_max_stocks():
    ...
    filtered = backfill_module._filter_universe(universe, stage="stock", max_stocks=2, only_codes=[])
